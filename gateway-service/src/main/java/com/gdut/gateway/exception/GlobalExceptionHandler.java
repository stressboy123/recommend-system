...
import com.gdut.gateway.util.ResultUtils;
...
public class GlobalExceptionHandler {
    ...
    public Result<Void> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        return ResultUtils.fail(ResultCode.PARAM_ERROR.getCode(), errorMsg);
    }
    ...
    public Result<Void> handleNullPointerException(NullPointerException e) {
        log.error("空指针异常：", e);
        return ResultUtils.fail(ResultCode.SYSTEM_ERROR.getCode(), "系统异常：数据为空，请联系开发人员排查");
    }
    ...
    public Result<Void> handleException(Exception e) {
        ...
        return ResultUtils.fail(ResultCode.SYSTEM_ERROR.getCode(), "系统异常，请稍后重试");
    }
}
